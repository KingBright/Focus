...
final class CompletableHelper {
    static CallAdapter<Completable> createCallAdapter(Scheduler subscribeOn, Scheduler observeOn) {
        return new CompletableCallAdapter(subscribeOn, observeOn);
    }
    ...
    static class CompletableCallAdapter implements CallAdapter<Completable> {
        ...
        CompletableCallAdapter(Scheduler subscribeOn, Scheduler observeOn) {
